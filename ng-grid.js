...
var COMBO_VALUES = /COMBO_VALUES/g
...
var ngColumn = function (config, $scope, grid, domUtilityService, $templateCache, $utils) {
    ...
    self.feildType = colDef.feildType;
    if(self.enableCellEdit) {
       // console.info(self.feildType+"----");
        self.cellEditTemplate = colDef.cellEditTemplate || $templateCache.get('cellEditTemplate.html');
        
       /* if("comboBox" === self.feildType) {
            console.info("Adding combobox");
            var dsObject = colDef.values;
            console.info(dsObject);
             var optStr = "";
             for(var counter =0; counter < dsObject.length;counter++) {
                 optStr += "<option >"+dsObject[counter].PROJECT_NAME+"</option>";
             }
            self.editableCellTemplate =  $templateCache.get('editableComboCellTemplate.html').replace('@VALUES@',optStr);
        } else {*/
           // console.info("Adding text feild");
...
var ngGrid = function ($scope, options, sortService, domUtilityService, $filter, $templateCache, $utils, $timeout, $parse, $http, $q) {
        ...
        if (columnDefs.length > 0) {
            ...
            angular.forEach(columnDefs, function(colDef, i) {
                ...
                var column = new ngColumn({
                    ...
                    enableSort: self.config.enableSorting,
                    enablePinning: self.config.enablePinning,
                    showTitleBar: self.config.showTitleBar,
                    titleName: self.config.titleName,
    ...
    $scope.showTitleBar = self.config.showTitleBar; 
    $scope.titleName = self.config.titleName,
    $scope.footer = null;
...
var ngStyleProvider = function($scope, grid) {
    ...
    $scope.viewportStyle = function() {
        //alert("view port height:"+$scope.viewportDimHeight());
        ...
        compile: function() {
            return {
                pre: function($scope, iElement, iAttrs) {
                    ...
                    $timeout(function(){
                   console.info("**** dummy call to stop rendering grid tp load the data stores*****")
...
window.ngGrid.i18n['es'] = {
    ...
    ngPagerLastTitle: 'ï¿½?ltima PÃ¡gina'
};
window.ngGrid.i18n['fa'] = {
    ngAggregateLabel: 'ï¿½?ï¿½?Ø±Ø¯ï¿½?Ø§',
    ngGroupPanelDescription: 'ï¿½?Ú© Ø¹ï¿½?ï¿½?Ø§ï¿½? Ø³Øªï¿½?ï¿½? Ø§ï¿½?ï¿½?Ø¬Ø§ Ø±Ø§ Ø¨Ø±Ø¯Ø§Ø± ï¿½? Ø¨ï¿½? Ú¯Ø±ï¿½?ï¿½?ï¿½? Ø§Ø² Ø¢ï¿½? Ø³Øªï¿½?ï¿½? Ø¨ï¿½?Ø§ï¿½?Ø¯Ø§Ø².',
    ngSearchPlaceHolder: 'Ø¬Ø³ØªØ¬ï¿½?...',
    ngMenuText: 'Ø§ï¿½?ØªØ®Ø§Ø¨ Ø³Øªï¿½?ï¿½?\u200cï¿½?Ø§:',
    ngShowingItemsLabel: 'ï¿½?ï¿½?Ø§ï¿½?Ø´ ï¿½?ï¿½?Ø±Ø¯ï¿½?Ø§:',
    ngTotalItemsLabel: 'ï¿½?ï¿½?ï¿½?ï¿½? ï¿½?ï¿½?Ø±Ø¯ï¿½?Ø§:',
    ngSelectedItemsLabel: 'ï¿½?ï¿½?Ø±Ø¯ï¿½?Ø§ï¿½? Ø§ï¿½?ØªØ®Ø§Ø¨\u200cØ´Ø¯ï¿½?:',
    ngPageSizeLabel: 'Ø§ï¿½?Ø¯Ø§Ø²ï¿½?ï¿½? Øµï¿½?Ø­ï¿½?:',
    ngPagerFirstTitle: 'Øµï¿½?Ø­ï¿½?ï¿½? Ø§ï¿½?ï¿½?',
    ngPagerNextTitle: 'Øµï¿½?Ø­ï¿½?ï¿½? Ø¨Ø¹Ø¯',
    ngPagerPrevTitle: 'Øµï¿½?Ø­ï¿½?ï¿½? ï¿½?Ø¨ï¿½?',
    ngPagerLastTitle: 'Ø¢Ø®Ø±ï¿½?ï¿½? Øµï¿½?Ø­ï¿½?'
};
...
window.ngGrid.i18n['fr'] = {
    ...
    ngSelectedItemsLabel: 'ï¿½?lÃ©ments Articles:',
...
window.ngGrid.i18n['zh-cn'] = {
    ngAggregateLabel: 'ï¿½?ï¿½ï¿½?ï¿½',
    ngGroupPanelDescription: 'ï¿½??ï¿½?ï¿½è¡¨å¤´ï¿½?ï¿½æ­¤ï¿½ï¿½?ä»¥ï¿½ï¿½?ï¿½ï¿½?ï¿½??ï¿½ï¿½?',
    ngSearchPlaceHolder: 'ï¿½??ç´¢...',
    ngMenuText: 'ï¿½?ï¿½ï¿½?ï¿½ï¿½??ï¿½ï¿½?ï¿½ï¿½?ï¿½??ï¿½?ï¿½ï¿½??ï¿½ï¿½?',
    ngShowingItemsLabel: 'ï¿½ï¿½?ï¿½??ï¿½?ï¿½ç¤ºï¿½?ï¿½ï¿½?ï¿½ï¿½ï¿½?',
    ngTotalItemsLabel: 'ï¿½?ï¿½ï¿½?ï¿½ï¿½?ï¿½ï¿½?ï¿½ï¿½ï¿½?',
    ngSelectedItemsLabel: 'ï¿½??ä¸­ï¿½?ï¿½ï¿½?ï¿½ï¿½ï¿½?',
    ngPageSizeLabel: 'ï¿½ï¿½?é¡µï¿½?ï¿½ç¤ºï¿½?ï¿½ï¿½ï¿½?',
    ngPagerFirstTitle: 'ï¿½??ï¿½?ï¿½ï¿½ï¿½?é¡µ',
    ngPagerNextTitle: 'ï¿½ï¿½?ï¿½ï¿½?é¡µ',
    ngPagerPrevTitle: 'ï¿½ï¿½?ï¿½ï¿½?é¡µ',
    ngPagerLastTitle: 'ï¿½??ï¿½ï¿½?å°¾é¡µ' 
};

window.ngGrid.i18n['zh-tw'] = {
    ngAggregateLabel: 'ï¿½ï¿½?',
    ngGroupPanelDescription: 'ï¿½??ï¿½??è¡¨é ­ï¿½?ï¿½æ­¤ï¿½??ä»¥ï¿½?ï¿½ï¿½ï¿½?ï¿½??ï¿½ï¿½?',
    ngSearchPlaceHolder: 'ï¿½??ï¿½ï¿½?...',
    ngMenuText: 'ï¿½?ï¿½ï¿½??ï¿½ï¿½?ï¿½ï¿½?ï¿½ï¿½?',
    ngShowingItemsLabel: 'ï¿½?ï¿½ï¿½??é¡¯ç¤ºï¿½ï¿½?ï¿½?ï¿½ï¿½ï¿½?',
    ngTotalItemsLabel: 'ç¸½ï¿½ï¿½?ï¿½?ï¿½ï¿½ï¿½?',
    ngSelectedItemsLabel: 'ï¿½?ï¿½ï¿½??ï¿½ï¿½?ï¿½?ï¿½ï¿½ï¿½?',
    ngPageSizeLabel: 'ï¿½ï¿½?ï¿½ï¿½?é¡¯ç¤ºï¿½ï¿½?',
    ngPagerFirstTitle: 'ç¬¬ï¿½ï¿½?ï¿½ï¿½?',
    ngPagerNextTitle: 'ï¿½ï¿½?ï¿½ï¿½?ï¿½ï¿½?',
    ngPagerPrevTitle: 'ï¿½ï¿½?ï¿½ï¿½?ï¿½ï¿½?',
    ngPagerLastTitle: 'ï¿½??ï¿½ï¿½?ï¿½ï¿½?'
};
...
angular.module('ngGrid').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('editableCellTemplate.html',
    "<input testing ng-class=\"'colt' + col.index\" ng-input=\"COL_FIELD\" ng-model=\"COL_FIELD\" />"
  );

  $templateCache.put('editableComboCellTemplate.html',
    "<select  ng-class=\"'colt' + col.index\" ng-input=\"COL_FIELD\" ng-model=\"COL_FIELD\" >@VALUES@</select>"
  );
  ...
  $templateCache.put('gridTemplate.html',
    ...
    "    <div ng-show=\"showTitleBar\" class=\"ngGridActionBar\" ng-style=\"headerStyle()\" >\r" +
    "\n" +
    "        <div>&nbsp;&nbsp;{{titleName}}</div>\r" +
    "\n" +
    "    </div>\r" +
